...
public sealed class BaseItemRepositoryLegacyFilterTests : IDisposable
{
    ...
    // Verifies eligible tags retain normalized result semantics while using one direct ItemValues join.
    [Fact]
    public void GetQueryFiltersLegacy_Tags_GroupByCleanValueWithOneItemValuesJoin()
    {
